...
## Schritt 12 — Neue Techniken Mai 2026 (Codrops)
...
**Wann verwenden:** Wenn WebGL-Setup (Three.js/Shader) overkill ist — für Page Transitions, Hero-Reveals, Section-Wipes.
...
```javascript
// SVG Blob Morphing via d-Attribut (kein Plugin nötig)
const paths = [
