...
## Corpus Check
- 1 files · ~170,928 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 101 nodes · 125 edges · 16 communities detected
...
- `Bento Grid / Asymmetric CSS Grid Layout` --semantically_similar_to--> `Double-Bezel (Doppelrand) Nested Container Architecture`  [INFERRED] [semantically similar]
  skills/taste-skill/SKILL.md → skills/soft-skill/SKILL.md
...
- `Anti-Slop Design Engineering Rules (Bias Correction)` --exemplifies--> `Floria Asymmetric Left-Aligned Hero Layout`  [INFERRED]
  skills/taste-skill/skills/taste-skill/SKILL.md → skills/taste-skill/examples/floria-top.webp
- `Anti-Slop Design Engineering Rules (Bias Correction)` --exemplifies--> `Floria Scattered Testimonial Card Layout`  [INFERRED]
  skills/taste-skill/skills/taste-skill/SKILL.md → skills/taste-skill/examples/floria-bottom.webp
...
Cohesion: 0.15
Nodes (19): Industrial Brutalism & Tactical Telemetry UI (brutalist-skill), Anti-Slop / Anti-Generic AI Design Rules, Banned Fonts List (Inter, Roboto, Arial, Open Sans), Tactical Telemetry / CRT Terminal Archetype, Design Audit â€“ Systematic Upgrade Checklist, Inline Image Typography (photos embedded in headlines), Premium / Anti-Generic UI Design Principle, DESIGN.md â€“ Single Source of Truth for Google Stitch (+11 more)
...
## Knowledge Gaps
- **43 isolated node(s):** `update_map.py — Wird von der GitHub Action aufgerufen. Generiert graphify-out/in`, `Design Advisor (design)`, `Inline Image Typography (photos embedded in headlines)`, `Design Audit â€“ Systematic Upgrade Checklist`, `Rationale: Ban Inter font to avoid generic AI aesthetic` (+38 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 7`** (2 nodes): `Chunked Task Execution Pattern`, `Verification Loops (Chain of Verification, Reverse Prompting, Self-Grading)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 8`** (2 nodes): `Explicit Syntax Binding (Anti-Truncation)`, `Reference Prompt Templates for Complete Output`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 9`** (2 nodes): `Consumer Middleware Truncation Problem`, `Context Window Asymmetry (Large Input, Capped Output)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 10`** (1 nodes): `Temperature Parameter for Token Distribution`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 11`** (1 nodes): `Top-p Nucleus Sampling`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 12`** (1 nodes): `XML-Structured Prompt Architecture`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 13`** (1 nodes): `Continuation Handling Prompt Template`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (1 nodes): `Metacognitive Laziness and Human Feedback Loop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (1 nodes): `Dynamic Throttling During Peak Demand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `LLM Laziness Research References` connect `Community 1` to `Community 5`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `design-taste-frontend SKILL (High-Agency Frontend)` connect `Community 2` to `Community 1`?**
