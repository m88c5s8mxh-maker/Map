...
## Corpus Check
- 2 files · ~304,848 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 599 nodes · 674 edges · 62 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Design Skills — Taste, Premium UI, Anti-Slop|Community 0]]
- [[_COMMUNITY_Skills Library und Claude Config|Community 1]]
- [[_COMMUNITY_LLM Laziness und Anti-Truncation Research|Community 2]]
- [[_COMMUNITY_Stitch Design System und Floria Brand|Community 3]]
- [[_COMMUNITY_Sales Intelligence und Competitive Enablement|Community 4]]
- [[_COMMUNITY_Product Analytics, Metrics und Dashboards|Community 5]]
- [[_COMMUNITY_Outreach, Email und Gmail Automation|Community 6]]
- [[_COMMUNITY_HR und People Operations|Community 7]]
- [[_COMMUNITY_Engineering Workflow und DevOps|Community 8]]
- [[_COMMUNITY_Product Management und UX Research|Community 9]]
- [[_COMMUNITY_High-End UI Engineering und Motion Design|Community 10]]
- [[_COMMUNITY_Data Engineering und Financial Queries|Community 11]]
- [[_COMMUNITY_Content Creation und SEO Copywriting|Community 12]]
- [[_COMMUNITY_Financial Statements und Sales Forecasting|Community 13]]
- [[_COMMUNITY_Cinematic Web, AI Video und Bayern-Oberpfalz|Community 14]]
- [[_COMMUNITY_Data Visualization und Warehouse|Community 15]]
- [[_COMMUNITY_Knowledge Management, Runbooks und SOPs|Community 16]]
- [[_COMMUNITY_UX Writing und Web Components|Community 17]]
- [[_COMMUNITY_System Architecture und Stakeholder Communication|Community 18]]
- [[_COMMUNITY_Sales Pipeline und CRM Operations|Community 19]]
- [[_COMMUNITY_Search Strategy und MCP Sources|Community 20]]
- [[_COMMUNITY_Agile Sprint Planning und Tech Debt|Community 21]]
- [[_COMMUNITY_Compensation Analysis und HR|Community 22]]
- [[_COMMUNITY_DOCX Document Generation|Community 23]]
- [[_COMMUNITY_Incident Response und Internal Comms|Community 24]]
- [[_COMMUNITY_Compliance und Security GDPR SOC2|Community 25]]
- [[_COMMUNITY_Claude Memory und Task Management|Community 26]]
- [[_COMMUNITY_Graph Auto-Update Script|Community 27]]
- [[_COMMUNITY_PDF Generation und OCR|Community 28]]
- [[_COMMUNITY_Accounting Reconciliation|Community 29]]
- [[_COMMUNITY_Data Profiling und Quality|Community 30]]
- [[_COMMUNITY_Claude Memory Architecture|Community 31]]
- [[_COMMUNITY_Cowork Connectors und Plugins|Community 32]]
- [[_COMMUNITY_Skill Design und Optimization|Community 33]]
- [[_COMMUNITY_SEO Strategy und Keyword Research|Community 34]]
- [[_COMMUNITY_Lead Enrichment und Apollo CRM|Community 35]]
- [[_COMMUNITY_YouTube und Faceless Content Creation|Community 36]]
- Community 37
- [[_COMMUNITY_Job Offers und Offer Letters|Community 38]]
- [[_COMMUNITY_Interview Preparation|Community 39]]
- [[_COMMUNITY_Glassmorphism und Manus VACU Landing|Community 40]]
- [[_COMMUNITY_PowerPoint PPTX Generation|Community 41]]
- [[_COMMUNITY_Slack GIF Creator|Community 42]]
- [[_COMMUNITY_SQL Queries und Analytics|Community 43]]
- [[_COMMUNITY_React und Framer Motion Components|Community 44]]
- [[_COMMUNITY_Chunked Execution und Verification Loops|Community 45]]
- [[_COMMUNITY_Anti-Truncation Prompt Patterns|Community 46]]
- [[_COMMUNITY_LLM Context und Truncation Limits|Community 47]]
- [[_COMMUNITY_Memory Consolidation|Community 48]]
- [[_COMMUNITY_User Context Ulm DE|Community 49]]
- [[_COMMUNITY_Scheduled Tasks und Cron Jobs|Community 50]]
- [[_COMMUNITY_Template Library und Blueprint Saver|Community 51]]
- [[_COMMUNITY_Theme und Color Palette Factory|Community 52]]
- [[_COMMUNITY_LLM Temperature Tuning|Community 53]]
- [[_COMMUNITY_Top-p Nucleus Sampling|Community 54]]
- [[_COMMUNITY_XML Prompt Architecture|Community 55]]
- [[_COMMUNITY_Continuation Prompt Handling|Community 56]]
- [[_COMMUNITY_Metacognitive Laziness LLM|Community 57]]
- [[_COMMUNITY_Dynamic Throttling LLM|Community 58]]
- [[_COMMUNITY_Call Preparation Workflow|Community 59]]
- [[Community_60|Community 60]]
- Community 61

## God Nodes (most connected - your core abstractions)
1. `Taste Skill (design-taste-frontend)` - 14 edges
2. `DESIGN.md — Stitch Design System Document` - 13 edges
3. `LLM Output Truncation Research — root causes, remediation, empirical findings` - 12 edges
4. `Taste Skill README â€“ Collection Overview` - 10 edges
5. `output-skill — Stops AI from being lazy, prevents placeholder comments and skipped code` - 9 edges
6. `design-taste-frontend SKILL (High-Agency Frontend)` - 9 edges
7. `metrics-review` - 9 edges
8. `roadmap-update` - 9 edges
9. `taste-skill SKILL.md — High-Agency Frontend Skill` - 9 edges
10. `LLM Laziness Research References` - 8 edges
...
Cohesion: 0.09
Nodes (31): Attribution Modeling, Customer Acquisition Cost (CAC), Resource Capacity Planning, Product Analytics Connector, Project Tracker Connector, Dashboard Design Principles, DAU/WAU/MAU (Active User Metrics), Jobs-to-be-Done (JTBD) (+23 more)
...
Cohesion: 0.12
Nodes (22): 30/60/90-Day Onboarding Plan, Attrition Analysis, Performance Calibration, HRIS Connector, Diversity Representation Metrics, Employee Handbook, eNPS (Employee Net Promoter Score), Headcount Planning (+14 more)
...
Cohesion: 0.21
Nodes (14): Bayern / Oberpfalz Location Pattern, Cinematic Web Skill, Feedback-Protokoll (Prompt Learning Loop), 5-Element Prompt Formula, GSAP + Lenis Animation Stack, Kling 3.0 AI Video Platform, Kling Prompts Skill, Monte Kaolino (Hirschau, Oberpfalz) (+6 more)
...
Cohesion: 0.22
Nodes (10): Architecture Decision Record, Green/Yellow/Red Status, KPI Reporting, ROAM Risk Framework, Stakeholder Audience Segmentation, System Architecture Design, Trade-off Analysis, stakeholder-update (+2 more)

### Community 19 - "Community 19"
Cohesion: 0.25
Nodes (9): CRM Connector, CRM Hygiene, Deal Prioritization Framework, Ideal Customer Profile (ICP), Sales Pipeline Health Score, Sales Operations Domain, pipeline-review, prospect (+1 more)

### Community 20 - "Community 20"
Cohesion: 0.31
Nodes (9): MCP Connected Sources, Parallel Search Execution, Query Decomposition, Rate Limit Handling, Result Ranking and Deduplication, MCP Source Priority Ordering, search, search-strategy (+1 more)

### Community 21 - "Community 21"
Cohesion: 0.29
Nodes (8): Backlog Prioritization, Sprint Capacity Planning, Standup Format (Yesterday/Today/Blockers), Technical Debt Categories, Tech Debt Prioritization Framework, sprint-planning, standup, tech-debt
...
Cohesion: 0.33
Nodes (6): Memory Gap Filling, TASKS.md Task File, Working Memory Bootstrap, update, start, task-management

### Community 27 - "Community 27"
Cohesion: 0.4
Nodes (1): update_map.py — Wird von der GitHub Action aufgerufen. Generiert graphify-out/in
...
Cohesion: 0.5
Nodes (4): Channel Forensics, Faceless YouTube Channel, Viral Title Production, youtube-channel-ai
...
- `Swiss Typographic Design` → `Tactical Telemetry / CRT Terminal Archetype`  [AMBIGUOUS]
  skills/brutalist-skill/SKILL.md · relation: semantically_similar_to

## Knowledge Gaps
- **307 isolated node(s):** `update_map.py — Wird von der GitHub Action aufgerufen. Generiert graphify-out/in`, `Design Advisor (design)`, `Inline Image Typography (photos embedded in headlines)`, `Rationale: Ban Inter font to avoid generic AI aesthetic`, `Rationale: Spring physics over linear easing for premium feel` (+302 more)
...
- **Thin community `Community 47`** (2 nodes): `Explicit Syntax Binding (Anti-Truncation)`, `Reference Prompt Templates for Complete Output`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `Consumer Middleware Truncation Problem`, `Context Window Asymmetry (Large Input, Capped Output)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `Memory Consolidation`, `consolidate-memory`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `User Context (Ulm, DE)`, `conversation-context`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `Scheduled Task / Cron Job`, `schedule`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `Blueprint Template Library`, `template-saver`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `Theme Palette`, `theme-factory`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Temperature Parameter for Token Distribution`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Top-p Nucleus Sampling`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `XML-Structured Prompt Architecture`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `Continuation Handling Prompt Template`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `Metacognitive Laziness and Human Feedback Loop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Dynamic Throttling During Peak Demand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Call Preparation Workflow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Component Stylings — Buttons, Cards, Inputs, Navigation, Loaders, Empty States`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `content-creation` connect `Community 4` to `Community 17`?**
